import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, D as is_function, E as cubicOut, F as validate_each_keys, o as onMount, G as text, H as claim_text, I as listen_dev, J as set_data_dev, K as fix_position, L as create_animation, M as update_keyed_each, N as fix_and_destroy_block, O as fade, P as fly, k as create_component, l as claim_component, m as mount_component, t as transition_in, Q as add_render_callback, R as create_bidirectional_transition, T as create_in_transition, p as transition_out, q as destroy_component, U as check_outros, V as group_outros } from './client.7695a46d.js';
...
// (95:2) {#each projects as project (project)}
function create_each_block$1(key_1, ctx) {
	let div;
	let t0_value = /*project*/ ctx[4] + "";
	let t0;
	let t1;
	let rect;
	...
	function click_handler(...args) {
		return /*click_handler*/ ctx[2](/*project*/ ctx[4], ...args);
	}
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 95, 3, 3004);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*projects*/ 1 && t0_value !== (t0_value = /*project*/ ctx[4] + "")) set_data_dev(t0, t0_value);
		},
		r: function measure() {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(95:2) {#each projects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	validate_each_argument(each_value);
	const get_key = ctx => /*project*/ ctx[4];
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 83, 1, 1652);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 86, 40, 1723);
			add_location(br0, file$3, 87, 2, 2091);
			add_location(br1, file$3, 87, 9, 2098);
			add_location(br2, file$3, 89, 2, 2520);
			add_location(br3, file$3, 89, 9, 2527);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 85, 1, 1678);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 93, 1, 2928);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 82, 0, 1616);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	let showProjects = [];
	const remove = n => $$invalidate(0, projects = projects.filter(p => p !== n));
	const writable_props = [];
	...
	$$self.$inject_state = $$props => {
		...
		if ("showProjects" in $$props) showProjects = $$props.showProjects;
	};
	...
	return [projects, remove, click_handler];
}
