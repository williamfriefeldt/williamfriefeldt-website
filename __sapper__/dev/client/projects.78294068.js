import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, o as onMount, D as fly, E as text, F as claim_text, G as add_render_callback, H as create_bidirectional_transition, t as transition_in, I as group_outros, p as transition_out, J as check_outros, K as fade, k as create_component, l as claim_component, m as mount_component, L as create_in_transition, q as destroy_component, M as listen_dev } from './client.96c6f2f4.js';
...
// (97:2) {#each visibleProjects as project}
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 97, 3, 2989);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(97:2) {#each visibleProjects as project}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	let div0;
	let current;
	let each_value = visibleProjects;
	validate_each_argument(each_value);
	let each_blocks = [];
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*visibleProjects*/ 0) {
				each_value = visibleProjects;
				validate_each_argument(each_value);
				let i;
