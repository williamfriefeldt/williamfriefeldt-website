...
// (109:2) {#each visibleProjects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 109, 3, 3210);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(109:2) {#each visibleProjects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 97, 1, 1851);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 100, 40, 1922);
			add_location(br0, file$3, 101, 2, 2290);
			add_location(br1, file$3, 101, 9, 2297);
			add_location(br2, file$3, 103, 2, 2719);
			add_location(br3, file$3, 103, 9, 2726);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 99, 1, 1877);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 107, 1, 3127);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 96, 0, 1815);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
