...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 107, 3, 3149);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
