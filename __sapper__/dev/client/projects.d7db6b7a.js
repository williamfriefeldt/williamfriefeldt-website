import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, D as validate_each_keys, o as onMount, E as text, F as claim_text, G as fix_position, H as create_animation, I as update_keyed_each, J as fix_and_destroy_block, K as fade, L as fly$1, k as create_component, l as claim_component, m as mount_component, t as transition_in, M as add_render_callback, N as create_bidirectional_transition, O as create_in_transition, p as transition_out, q as destroy_component, P as listen_dev, Q as check_outros, R as group_outros } from './client.a642140c.js';
...
// (98:2) {#each visibleProjects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 98, 3, 3028);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(98:2) {#each visibleProjects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 86, 1, 1669);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 89, 40, 1740);
			add_location(br0, file$3, 90, 2, 2108);
			add_location(br1, file$3, 90, 9, 2115);
			add_location(br2, file$3, 92, 2, 2537);
			add_location(br3, file$3, 92, 9, 2544);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 88, 1, 1695);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 96, 1, 2945);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 85, 0, 1633);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
	...
	const block = {
		...
		i: function intro(local) {
			...
			if (local) {
				if (!h3_intro) {
					add_render_callback(() => {
						h3_intro = create_in_transition(h3, fly$1, { y: -50, duration: 2000, delay: 3500 });
						h3_intro.start();
					});
				}
			}
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		i: function intro(local) {
			if (!li_intro) {
				add_render_callback(() => {
					li_intro = create_in_transition(li, fly$1, {
						y: -50,
						duration: 2000,
