...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-1fklp3");
			add_location(div, file$3, 97, 6, 2996);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t0);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1fklp3");
			add_location(h1, file$3, 84, 1, 1623);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-1fklp3");
			add_location(a, file$3, 87, 40, 1694);
			add_location(br0, file$3, 88, 2, 2062);
			add_location(br1, file$3, 88, 9, 2069);
			add_location(br2, file$3, 90, 2, 2491);
			add_location(br3, file$3, 90, 9, 2498);
			attr_dev(p, "class", "svelte-1fklp3");
			add_location(p, file$3, 86, 1, 1649);
			attr_dev(div0, "class", "poddsok-projects svelte-1fklp3");
			add_location(div0, file$3, 94, 1, 2899);
			attr_dev(div1, "class", "poddsok-description svelte-1fklp3");
			add_location(div1, file$3, 83, 0, 1587);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
