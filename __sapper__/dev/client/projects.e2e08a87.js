import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, D as is_function, E as cubicOut, F as validate_each_keys, G as text, H as claim_text, I as listen_dev, J as set_data_dev, K as fix_position, L as create_animation, M as update_keyed_each, N as fix_and_destroy_block, o as onMount, O as fade, P as fly, k as create_component, l as claim_component, m as mount_component, t as transition_in, Q as add_render_callback, R as create_bidirectional_transition, T as create_in_transition, p as transition_out, q as destroy_component, U as check_outros, V as group_outros } from './client.9f485499.js';
...
// (92:2) {#each projects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 92, 3, 2941);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*projects*/ 1 && t0_value !== (t0_value = /*project*/ ctx[3] + "")) set_data_dev(t0, t0_value);
		},
		r: function measure() {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(92:2) {#each projects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 80, 1, 1589);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 83, 40, 1660);
			add_location(br0, file$3, 84, 2, 2028);
			add_location(br1, file$3, 84, 9, 2035);
			add_location(br2, file$3, 86, 2, 2457);
			add_location(br3, file$3, 86, 9, 2464);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 82, 1, 1615);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 90, 1, 2865);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 79, 0, 1553);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ flip, projects, remove });
