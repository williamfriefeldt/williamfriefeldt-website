...
// (103:2) {#each projects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 103, 3, 3027);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(103:2) {#each projects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 91, 1, 1675);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 94, 40, 1746);
			add_location(br0, file$3, 95, 2, 2114);
			add_location(br1, file$3, 95, 9, 2121);
			add_location(br2, file$3, 97, 2, 2543);
			add_location(br3, file$3, 97, 9, 2550);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 93, 1, 1701);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 101, 1, 2951);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 90, 0, 1639);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
