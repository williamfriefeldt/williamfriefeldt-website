...
// (108:2) {#each visibleProjects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 108, 3, 3190);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(108:2) {#each visibleProjects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 96, 1, 1831);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 99, 40, 1902);
			add_location(br0, file$3, 100, 2, 2270);
			add_location(br1, file$3, 100, 9, 2277);
			add_location(br2, file$3, 102, 2, 2699);
			add_location(br3, file$3, 102, 9, 2706);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 98, 1, 1857);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 106, 1, 3107);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 95, 0, 1795);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
