import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, D as validate_each_keys, o as onMount, E as fly, F as text, G as claim_text, H as fix_position, I as create_animation, J as update_keyed_each, K as fix_and_destroy_block, L as fade, k as create_component, l as claim_component, m as mount_component, t as transition_in, M as add_render_callback, N as create_bidirectional_transition, O as create_in_transition, p as transition_out, q as destroy_component, P as listen_dev, Q as check_outros, R as group_outros } from './client.2b983d85.js';
...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 98, 3, 3027);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 86, 1, 1668);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 89, 40, 1739);
			add_location(br0, file$3, 90, 2, 2107);
			add_location(br1, file$3, 90, 9, 2114);
			add_location(br2, file$3, 92, 2, 2536);
			add_location(br3, file$3, 92, 9, 2543);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 88, 1, 1694);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 96, 1, 2944);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 85, 0, 1632);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
