...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-1khm253");
			add_location(div, file$3, 89, 3, 2851);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1khm253");
			add_location(h1, file$3, 77, 1, 1499);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-1khm253");
			add_location(a, file$3, 80, 40, 1570);
			add_location(br0, file$3, 81, 2, 1938);
			add_location(br1, file$3, 81, 9, 1945);
			add_location(br2, file$3, 83, 2, 2367);
			add_location(br3, file$3, 83, 9, 2374);
			attr_dev(p, "class", "svelte-1khm253");
			add_location(p, file$3, 79, 1, 1525);
			attr_dev(div0, "class", "poddsok-projects svelte-1khm253");
			add_location(div0, file$3, 87, 1, 2775);
			attr_dev(div1, "class", "poddsok-description svelte-1khm253");
			add_location(div1, file$3, 76, 0, 1463);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
