import { r as cubicInOut, n as noop, u as now, w as loop, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, x as validate_each_argument, v as validate_slots, e as element, y as space, c as claim_element, a as children, z as claim_space, b as detach_dev, A as set_style, h as add_location, j as insert_dev, B as append_dev, C as destroy_each, f as attr_dev, D as is_function, E as cubicOut, F as validate_each_keys, o as onMount, G as text, H as claim_text, I as fix_position, J as create_animation, K as update_keyed_each, L as fix_and_destroy_block, M as fade, N as fly, k as create_component, l as claim_component, m as mount_component, t as transition_in, O as add_render_callback, P as create_bidirectional_transition, Q as create_in_transition, p as transition_out, q as destroy_component, R as listen_dev, T as check_outros, U as group_outros } from './client.e398967b.js';
...
// (107:2) {#each projects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 107, 3, 3145);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(107:2) {#each projects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 95, 1, 1793);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 98, 40, 1864);
			add_location(br0, file$3, 99, 2, 2232);
			add_location(br1, file$3, 99, 9, 2239);
			add_location(br2, file$3, 101, 2, 2661);
			add_location(br3, file$3, 101, 9, 2668);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 97, 1, 1819);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 105, 1, 3069);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 94, 0, 1757);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("visibleProjects" in $$props) visibleProjects = $$props.visibleProjects;
	};
