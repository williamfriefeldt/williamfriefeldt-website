...
// (85:2) {#each projects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-1g8irqz");
			add_location(div, file$3, 85, 3, 2777);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(85:2) {#each projects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-1g8irqz");
			add_location(h1, file$3, 73, 1, 1425);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-1g8irqz");
			add_location(a, file$3, 76, 40, 1496);
			add_location(br0, file$3, 77, 2, 1864);
			add_location(br1, file$3, 77, 9, 1871);
			add_location(br2, file$3, 79, 2, 2293);
			add_location(br3, file$3, 79, 9, 2300);
			attr_dev(p, "class", "svelte-1g8irqz");
			add_location(p, file$3, 75, 1, 1451);
			attr_dev(div0, "class", "poddsok-projects svelte-1g8irqz");
			add_location(div0, file$3, 83, 1, 2701);
			attr_dev(div1, "class", "poddsok-description svelte-1g8irqz");
			add_location(div1, file$3, 72, 0, 1389);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
