...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-kgpdyu");
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(p, "class", "svelte-kgpdyu");
			add_location(p, file$3, 79, 1, 1525);
			attr_dev(div0, "class", "poddsok-projects svelte-kgpdyu");
			add_location(div0, file$3, 87, 1, 2775);
			attr_dev(div1, "class", "poddsok-description svelte-kgpdyu");
