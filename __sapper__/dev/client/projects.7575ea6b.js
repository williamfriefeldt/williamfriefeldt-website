...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-70uz14");
			add_location(div, file$3, 88, 3, 2834);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-70uz14");
			add_location(h1, file$3, 76, 1, 1482);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-70uz14");
			add_location(a, file$3, 79, 40, 1553);
			add_location(br0, file$3, 80, 2, 1921);
			add_location(br1, file$3, 80, 9, 1928);
			add_location(br2, file$3, 82, 2, 2350);
			add_location(br3, file$3, 82, 9, 2357);
			attr_dev(p, "class", "svelte-70uz14");
			add_location(p, file$3, 78, 1, 1508);
			attr_dev(div0, "class", "poddsok-projects svelte-70uz14");
			add_location(div0, file$3, 86, 1, 2758);
			attr_dev(div1, "class", "poddsok-description svelte-70uz14");
			add_location(div1, file$3, 75, 0, 1446);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
