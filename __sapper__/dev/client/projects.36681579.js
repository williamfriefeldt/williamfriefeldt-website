...
// (107:2) {#each visibleProjects as project (project)}
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$3, 107, 3, 3156);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(107:2) {#each visibleProjects as project (project)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file$3, 95, 1, 1797);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-199xhs7");
			add_location(a, file$3, 98, 40, 1868);
			add_location(br0, file$3, 99, 2, 2236);
			add_location(br1, file$3, 99, 9, 2243);
			add_location(br2, file$3, 101, 2, 2665);
			add_location(br3, file$3, 101, 9, 2672);
			attr_dev(p, "class", "svelte-199xhs7");
			add_location(p, file$3, 97, 1, 1823);
			attr_dev(div0, "class", "poddsok-projects svelte-199xhs7");
			add_location(div0, file$3, 105, 1, 3073);
			attr_dev(div1, "class", "poddsok-description svelte-199xhs7");
			add_location(div1, file$3, 94, 0, 1761);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
