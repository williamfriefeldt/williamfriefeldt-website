...
function create_each_block$1(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "poddsok-project svelte-16rpad7");
			add_location(div, file$3, 88, 3, 2818);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-16rpad7");
			add_location(h1, file$3, 76, 1, 1466);
			attr_dev(a, "href", "https://poddsok.nu");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-16rpad7");
			add_location(a, file$3, 79, 40, 1537);
			add_location(br0, file$3, 80, 2, 1905);
			add_location(br1, file$3, 80, 9, 1912);
			add_location(br2, file$3, 82, 2, 2334);
			add_location(br3, file$3, 82, 9, 2341);
			attr_dev(p, "class", "svelte-16rpad7");
			add_location(p, file$3, 78, 1, 1492);
			attr_dev(div0, "class", "poddsok-projects svelte-16rpad7");
			add_location(div0, file$3, 86, 1, 2742);
			attr_dev(div1, "class", "poddsok-description svelte-16rpad7");
			add_location(div1, file$3, 75, 0, 1430);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h1);
